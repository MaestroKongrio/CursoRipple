...
issuing_keypair = Keypair.from_secret(
    "SCHD2ZUA77YMTDSABME47MHIDNJYPKTAXHD6YZXXSCBFRG2NBI7QWVRC"
)
issuing_public = issuing_keypair.public_key

distributor_keypair = Keypair.from_secret(
    "SDIC3ENEWFMMBSM6JADPSXXR6TUTWOD3QBJFOKOSCWAO6IRYSNEWDOFC"
)
...
dolar_chilensis = Asset("USCL", issuing_public)
...
trust_transaction = (
    ...
    .append_change_trust_op(asset=dolar_chilensis, limit="1000")
    .set_timeout(100)
    .build()
)
